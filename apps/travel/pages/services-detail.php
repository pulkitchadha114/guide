                ...
                <div class="col-lg-8 col-sm-12 pe-lg-4">
                    <div class="about-content">
                        ...
                        <div class="about-image rounded mb-3 overflow-hidden">
                            <img src="/<?php echo STATIC_URL; ?>/tour/assets/images/trending/trending4.jpg" alt="" class="w-100">
                        </div>
                        ...
                        <div class="services-image d-flex mt-3 mb-3">
                            <div class="me-2 rounded overflow-hidden"><img src="/<?php echo STATIC_URL; ?>/tour/assets/images/trending/trending5.jpg" alt="" class="w-100"></div>
                            <div class="ms-2 rounded overflow-hidden"><img src="/<?php echo STATIC_URL; ?>/tour/assets/images/trending/trending6.jpg" alt="" class="w-100"></div>
                        </div>
                                        ...
                                        <div class="tab-content" id="postsTabContent1">
                                            ...
                                            <div class="tab-pane fade active show" id="popular" role="tabpanel">
                                                <article class="post mb-3 border-b pb-3">
                                                    <div class="s-content d-flex align-items-center justify-space-between">
                                                        <div class="sidebar-image w-25 me-3">
                                                            <a href="detail-1.php"><img src="/<?php echo STATIC_URL; ?>/tour/assets/images/trending/trending1.jpg" alt=""></a>
                                                        </div>
                                                        <div class="content-list w-75">
                                                            <h5 class="mb-1"><a href="detail-1.php">An Incredibly Easy Method That Works For All</a></h5>
                                                ...
                                                <article class="post border-b pb-3 mb-3">
                                                    <div class="s-content d-flex align-items-center justify-space-between">
                                                        <div class="sidebar-image w-25 me-3">
                                                            <a href="detail-1.php"><img src="/<?php echo STATIC_URL; ?>/tour/assets/images/trending/trending2.jpg" alt=""></a>
                                                        </div>
                                                        <div class="content-list w-75">
                                                            <h5 class="mb-1"><a href="detail-1.php">15 Unheard Ways To Achieve Greater Walker</a></h5>
                                                ...
                                                <article class="post">
                                                    <div class="s-content d-flex align-items-center justify-space-between">
                                                        <div class="sidebar-image w-25 me-3">
                                                            <a href="detail-1.php"><img src="/<?php echo STATIC_URL; ?>/tour/assets/images/trending/trending4.jpg" alt=""></a>
                                                        </div>
                                                        <div class="content-list w-75">
                                                            <h5 class="mb-1"><a href="detail-1.php">15 Unheard Ways To Achieve Greater Walker</a></h5>
